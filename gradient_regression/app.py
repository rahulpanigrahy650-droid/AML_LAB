...
def gradient_descent(x, y, w, b, learning_rate, iterations):
    ...
    for i in range(1, iterations + 1):
        ...
        cost = mse  # plain linear regression cost = MSE
...
def index():
    ...
    if request.method == "POST":
        ...
        final_w, final_b, history = gradient_descent(x, y, w, b, learning_rate, iterations)
        ...
        if show_graphs:
            ...
            plt.plot(x[sort_index], y_pred[sort_index], color="red", label="Regression Line")
